...
chmod +x $PWD/eclipse-dash/dash.jar $PWD/VehicleConnectSDK/Podfile.deps

java -jar $PWD/eclipse-dash/dash.jar $PWD/VehicleConnectSDK/Podfile.deps -summary $PWD/DEPENDENCIES
